...
* `segmentation/slic_superpixels.py`: `slic` function.  Docstring:
  ...
  image without ties.  That's good enough for now — along with some
  confirmation from someone who knows the algorithm.  Otherwise, do some more
  definitive investigation.  Awaiting response on Zulip.
  ...
  Provisional plan: (depending on confirmation of assumptions above)

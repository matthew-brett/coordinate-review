...
* `feature/template.py::match_template`:
  ...
  image : (I, J[, J]) array
      2-D or 3-D input image.
  template : (Q, R[, S]) array
      Template to locate. It must be `(Q <= I, R <= J[, S <= K])`.
  ```
...
* `registration/_optical_flow.py::optical_flow_tvl1` and `optical_flow_ilk`
  ...
  transpose-invariant (`./flow_3d_axes.ipynb`).  See summary in `ai_output/gemini_flow_invariance.md`.

...
* `skimage/transform/_warps.py`: `rotate`
  ...
  The second is that Skimage2 specifes the center for rotation as a coordinate in i, j (row, column) order, whereas Skimage1 asked for the center in (col, row) order.

...
* `segmentation/active_contour_model.py::active_contour`:
  ...
  image : 2D/3D array, optional channel axis — e.g shape (I, J) or (I, J, C)
      ...
      channel.
  ...
  channel_axis : str or int, optional
      This parameter indicates which axis of the `image` array corresponds to
      color channels.  Defaults to `last-if-3d`.  The default specifies that
      the last axis is the color channel, if the image array is 3-D; for 2-D
      images, there is no color channel.  An int gives the array axis
      containing the color channel.
  ```

  Add `last_channel_axis` decorator, and adapt to allow `last-if-3d`.  Or write
  logic inside function.  Test.

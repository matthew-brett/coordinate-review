...
* `hough_circle_peaks`.  This needs further analysis.  Accepts `hspace` array
  in form above, and returns coordinates, noted to be in x, y order.  However, how does the output change as a result of the modified `hspace` array?
